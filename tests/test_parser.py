...
class TestParser(unittest.TestCase):
    def test_movie_example_1(self):
        ...
        self.assertEqual(str(info), "The Walk 2015 720p")
        
    def test_movie_example_2(self):
        filename = "Alpha 2025 1080p WEBRip x264 AAC5 1-[YTS LT].mp4"
        info = parse_media_info(filename)
        self.assertEqual(str(info), "Alpha 2025 1080p")
    ...
    def test_movie_example_3(self):
        ...
        info = parse_media_info(filename)
        self.assertEqual(str(info), "In His Steps 2013 720p")
...
○ Episode Rating: 8.0 (5200)"""
        info = parse_media_info(filename, caption)
        ...
        self.assertEqual(str(info), "Jujutsu Kaisen 2023 720p S01E01")
    ...
    def test_series_standard_filename(self):
        ...
        self.assertEqual(str(info), "Breaking Bad 1080p S05E14")

    def test_series_one_piece(self):
        filename = "[SubGroup] One Piece - 1015 [1080p].mkv"
        info = parse_media_info(filename)
        # Should detect Episode 1015. Season default S01?
        # Output: One Piece 1080p S01E1015
        self.assertEqual(str(info), "One Piece 1080p S01E1015")
